...
let speedVal=1;function createPlaybackSpeedSlider(defaultPlaybackSpeed){$("#speed-input").slider({range:false,min:1000,max:2000,value:defaultPlaybackSpeed*1000+500,step:250,change:function(event,ui){gw.setAnimationDuration(2200-ui.value);},slide:function(event,ui){speedVal=0.5+(ui.value-1000)/1000
